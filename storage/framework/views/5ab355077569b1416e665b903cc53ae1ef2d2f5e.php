                ...
                <div class="card-body install-card-body h-100 w-100 z-3 position-relative">
                    ...
                    <div class="text-center mar-top pad-top">
                        <div id="loader" style="margin-top: 20px; display: none; transition: all 0.5s;">
                            <img loading="lazy"  src="<?php echo e(asset('loader.gif')); ?>" alt="" width="20">
                            &nbsp; Importing database ....
                        </div>
                    </div>
                    
                    <div class="mb-4 pb-4 absolute-bottom-left right-0 d-flex justify-content-center">
                      <a href="<?php echo e(route('step3')); ?>" class="back-btn-svg mr-3" title="Go Back" style="box-shadow: 0px 8px 16px rgb(255 88 0 / 16%); border-radius: 50%;">
                      ...
                      <a href="<?php echo e(route('import_sql')); ?>" class="btn btn-install text-uppercase" onclick="showLoder()">Import SQL</a>
                    </div>
                </div>

                <!-- Common file -->
                <?php echo $__env->make('installation.common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('backend.layouts.blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/active-ecommerce/resources/views/installation/step4.blade.php ENDPATH**/ ?>