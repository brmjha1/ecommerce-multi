                ...
                <table class="table table-striped aiz-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>8.0</td>
                            <td>
                                <?php if(floatval(phpversion()) >= 8.0): ?>
                        ...
                        <tr>
                            ...
                            <td>10.0+</td>
                            <td>
                                <?php if(floatval(explode("-",$mysql_version)[0]) >= 10.0): ?>
                                <i class="las la-check text-success"></i>
                                <?php else: ?>
                                <i class="las la-times text-danger"></i>
                                <?php endif; ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/active-ecommerce/resources/views/backend/system/server_status.blade.php ENDPATH**/ ?>