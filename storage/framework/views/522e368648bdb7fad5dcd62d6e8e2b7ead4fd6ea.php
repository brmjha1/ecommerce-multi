    ...
    <?php if($topbar_banner != null): ?>
        <div class="position-relative top-banner removable-session z-1035 d-none" data-key="top-banner"
            ...
            <a href="<?php echo e(get_setting('topbar_banner_link')); ?>" class="d-block text-reset">
                <img src="<?php echo e($topbar_banner_asset); ?>" class="d-none d-xl-block img-fit" alt="<?php echo e(translate('topbar_banner')); ?>">
                <!-- For Large device -->
                <img src="<?php echo e($topbar_banner_medium != null ? uploaded_asset($topbar_banner_medium) : $topbar_banner_asset); ?>"
                    class="d-none d-md-block d-xl-none img-fit" alt="<?php echo e(translate('topbar_banner')); ?>"> <!-- For Medium device -->
                <img src="<?php echo e($topbar_banner_small != null ? uploaded_asset($topbar_banner_small) : $topbar_banner_asset); ?>"
                    class="d-md-none img-fit" alt="<?php echo e(translate('topbar_banner')); ?>"> <!-- For Small device -->
            </a>
                    ...
                    <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0">
                        ...
                        <?php if(get_setting('show_language_switcher') == 'on'): ?>
                            <li class="list-inline-item dropdown mr-4" id="lang-change">
                                ...
                                <a href="javascript:void(0)" class="dropdown-toggle text-secondary fs-12 py-2"
                                    ...
                                    <span class=""><?php echo e($system_language->name); ?></span>
                                </a>
                                    ...
                                    <?php $__currentLoopData = get_all_active_language(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a href="javascript:void(0)" data-flag="<?php echo e($language->code); ?>"
                                                class="dropdown-item <?php if($system_language->code == $language->code): ?> active <?php endif; ?>">
                        ...
                        <?php if(get_setting('show_currency_switcher') == 'on'): ?>
                            <li class="list-inline-item dropdown ml-auto ml-lg-0 mr-0" id="currency-change">
                                ...
                                <a href="javascript:void(0)" class="dropdown-toggle text-secondary fs-12 py-2"
                                    data-toggle="dropdown" data-display="static">
                                    <?php echo e($system_currency->name); ?>

                                </a>
                                <ul class="dropdown-menu dropdown-menu-right dropdown-menu-lg-left">
                                    <?php $__currentLoopData = get_all_active_currency(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a class="dropdown-item <?php if($system_currency->code == $currency->code): ?> active <?php endif; ?>"
                        ...
                        <?php if(get_setting('vendor_system_activation') == 1): ?>
                            ...
                            <li class="list-inline-item mr-0 pl-0 py-2">
                                <a href="<?php echo e(route('shops.create')); ?>"
                                    class="text-secondary fs-12 pr-3 d-inline-block border-width-2 border-right"><?php echo e(translate('Become a Seller !')); ?></a>
                            </li>
                            <!-- Seller Login -->
                            <li class="list-inline-item mr-0 pl-0 py-2">
                                <a href="<?php echo e(route('seller.login')); ?>"
                                    class="text-secondary fs-12 pl-3 d-inline-block"><?php echo e(translate('Login to Seller')); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if(get_setting('helpline_number')): ?>
                            <!-- Helpline -->
                            <li class="list-inline-item ml-3 pl-3 mr-0 pr-0">
                                <a href="tel:<?php echo e(get_setting('helpline_number')); ?>"
            ...
            <div class="container">
                <div class="d-flex align-items-center">
                                ...
                                <a class="dropdown-toggle no-arrow text-secondary fs-12" data-toggle="dropdown"
                                    ...
                                    <span class="">
                                        <span class="position-relative d-inline-block">
                                            ...
                                            <?php if(Auth::check() && count($user->unreadNotifications) > 0): ?>
                                                <span
                                                    class="badge badge-primary badge-inline badge-pill absolute-top-right--10px"><?php echo e(count($user->unreadNotifications)); ?></span>
                                            <?php endif; ?>
                                        </span>
                                </a>
                    ...
                    <div class="ml-auto mr-0">
                        <?php if(auth()->guard()->check()): ?>
                            <span
                                class="d-none d-xl-flex align-items-center nav-user-info py-20px <?php if(isAdmin()): ?> ml-5 <?php endif; ?>"
                                id="nav-user-info">
                                <!-- Image -->
                                <span
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <a href="<?php echo e(route('categories.all')); ?>" class="text-reset">
                                        <span
                                            class="d-none d-lg-inline-block text-white hov-opacity-80">(<?php echo e(translate('See All')); ?>)</span>
                                    </a>
                                </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/active-ecommerce/resources/views/frontend/inc/nav.blade.php ENDPATH**/ ?>