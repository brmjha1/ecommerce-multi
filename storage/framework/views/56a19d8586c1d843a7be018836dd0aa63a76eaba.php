                    ...
                    <form method="POST" action="<?php echo e(route('system_settings')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control rounded-2 border aiz-selectpicker" style="height: 36px !important;" data-live-search="true" name="system_default_currency" required>
                                <?php $__currentLoopData = \App\Models\Currency::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('backend.layouts.blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/active-ecommerce/resources/views/installation/step5.blade.php ENDPATH**/ ?>