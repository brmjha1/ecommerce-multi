                    ...
                    <tbody>
                        <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo e(translate(ucfirst(str_replace('_', ' ', $payment->payment_method)))); ?> <?php if($payment->txn_code != null): ?> (<?php echo e(translate('TRX ID')); ?> : <?php echo e($payment->txn_code); ?>) <?php endif; ?>
                                </td>
                            </tr>
...
<?php echo $__env->make('seller.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/active-ecommerce/resources/views/seller/payment_history.blade.php ENDPATH**/ ?>