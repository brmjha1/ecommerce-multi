                ...
                <div class="card-body h-100 w-100 z-3">
                    ...
                    <form method="POST" action="<?php echo e(route('install.db')); ?>">
                        ...
                        <div class="mb-4 pb-4 absolute-bottom-left right-0 d-flex justify-content-center">
                            ...
                            ?>
                            <a href="<?php echo e($route); ?>" class="back-btn-svg mr-3" title="Go Back" style="box-shadow: 0px 8px 16px rgb(255 88 0 / 16%); border-radius: 50%;">
...
<?php echo $__env->make('backend.layouts.blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/active-ecommerce/resources/views/installation/step3.blade.php ENDPATH**/ ?>