            ...
            <div class="card install-card position-relative">
                ...
                <div class="card-body install-card-body h-100 w-100 z-3 position-relative">
                    ...
                    <p class="mb-4 pb-4 absolute-bottom-left right-0 d-flex justify-content-center">
                        <a href="<?php echo e(url('/')); ?>" class="back-btn-svg mr-3" title="Go Back" style="box-shadow: 0px 8px 16px rgb(255 88 0 / 16%); border-radius: 50%;">
                        ...
                        <?php if($permission['curl_enabled'] == 1 && $permission['db_file_write_perm'] == 1 && $permission['routes_file_write_perm'] == 1 && $phpVersion >= 7.20): ?>
                            <?php if($_SERVER['SERVER_NAME'] == 'localhost' || $_SERVER['SERVER_NAME'] == '127.0.0.1'): ?>
                                <a href = "<?php echo e(route('step3')); ?>" class="btn btn-install text-uppercase">Go To Next Step</a>
                            <?php else: ?>
                                <a href = "<?php echo e(route('step2')); ?>" class="btn btn-install text-uppercase">Go To Next Step</a>
                            <?php endif; ?>
                        <?php endif; ?>
                    </p>
                </div>
...
<?php echo $__env->make('backend.layouts.blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/active-ecommerce/resources/views/installation/step1.blade.php ENDPATH**/ ?>