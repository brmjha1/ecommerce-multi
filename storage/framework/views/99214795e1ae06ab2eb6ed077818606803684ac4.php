...
<?php $__env->startSection('panel_content'); ?>
                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <h3 class="mb-0 text-white fs-30">
                                <?php echo e(\App\Models\Product::where('user_id', Auth::user()->id)->count()); ?>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <h3 class="mb-0 text-white fs-30">
                                <?php echo e(Auth::user()->shop->rating); ?>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <h3 class="mb-0 text-white fs-30">
                                <?php echo e(\App\Models\Order::where('seller_id', Auth::user()->id)->where('delivery_status', 'delivered')->count()); ?>
    ...
    <div class="row">
                    ...
                    <p class="mt-4">
                        <?php
                            $orderTotal = \App\Models\Order::where('seller_id', Auth::user()->id)
                                ...
                                ->sum('grand_total');
                        ?>
                        <?php echo e(translate('Last Month')); ?>: <?php echo e(single_price($orderTotal)); ?>
                        ...
                        <?php $__currentLoopData = \App\Models\Category::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(count($category->products->where('user_id', Auth::user()->id)) > 0): ?>
                                <li class="d-flex justify-content-between align-items-center my-2 text-primary fs-13">
                                    ...
                                    <span class="">
                                        <?php echo e(count($category->products->where('user_id', Auth::user()->id))); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            ...
                            <h3 class="mb-0" style="color: #A9A3CC">
                                <?php echo e(\App\Models\OrderDetail::where('seller_id', Auth::user()->id)->where('delivery_status', 'pending')->count()); ?>
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            ...
                            <h3 class="mb-0" style="color: #A9A3CC">
                                <?php echo e(\App\Models\OrderDetail::where('seller_id', Auth::user()->id)->where('delivery_status', 'cancelled')->count()); ?>
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            ...
                            <h3 class="mb-0" style="color: #A9A3CC">
                                <?php echo e(\App\Models\OrderDetail::where('seller_id', Auth::user()->id)->where('delivery_status', 'on_the_way')->count()); ?>
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            ...
                            <h3 class="mb-0" style="color: #A9A3CC">
                                <?php echo e(\App\Models\OrderDetail::where('seller_id', Auth::user()->id)->where('delivery_status', 'delivered')->count()); ?>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            <?php if(addon_is_activated('seller_subscription')): ?>
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php if(Auth::user()->shop->seller_package): ?>
                            <div class="d-flex">
                                <div class="col-3">
                                    <img src="<?php echo e(uploaded_asset(Auth::user()->shop->seller_package->logo)); ?>"
                                        class="img-fluid mb-4 w-64px">
                                </div>
                                <div class="col-9">
                                    <a class="fw-600 mb-3 text-primary"><?php echo e(translate('Current Package')); ?>:</a>
                                    <h6 class="text-primary">
                                        <?php echo e(Auth::user()->shop->seller_package->name); ?>

                                        </h3>
                                        <p class="mb-1 text-muted"><?php echo e(translate('Product Upload Limit')); ?>:
                                            <?php echo e(Auth::user()->shop->product_upload_limit); ?> <?php echo e(translate('Times')); ?>

                                        </p>
                                        <p class="text-muted mb-4"><?php echo e(translate('Package Expires at')); ?>:
                                            <?php echo e(Auth::user()->shop->package_invalid_at); ?>
            ...
            <div
                ...
                <?php if(Auth::user()->shop->verification_status == 0): ?>
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
            <a href="<?php echo e(route('seller.products')); ?>" class="card mb-4 p-4 text-center h-180px">
                <div class="fs-16 fw-600 text-primary">
...
<?php echo $__env->make('seller.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/active-ecommerce/resources/views/seller/dashboard.blade.php ENDPATH**/ ?>