...
<?php $__env->startSection('content'); ?>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure SMTP correctly to enable this feature.')); ?> <a
                            href="<?php echo e(route('smtp_settings.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert text-center"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure Paypal correctly to enable this feature')); ?>. <a
                            href="<?php echo e(route('payment_method.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure Stripe correctly to enable this feature.')); ?> <a
                            href="<?php echo e(route('payment_method.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        <img class="float-left" src="<?php echo e(static_asset('assets/img/cards/sslcommerz.png')); ?>"
                            height="30">
                        <label class="aiz-switch aiz-switch-success mb-0 float-right">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure SSlCommerz correctly to enable this feature.')); ?> <a
                            href="<?php echo e(route('payment_method.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        <img class="float-left" src="<?php echo e(static_asset('assets/img/cards/instamojo.png')); ?>"
                            height="30">
                        <label class="aiz-switch aiz-switch-success mb-0 float-right">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure Instamojo Payment correctly to enable this feature')); ?>. <a
                            href="<?php echo e(route('payment_method.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        <img class="float-left" src="<?php echo e(static_asset('assets/img/cards/rozarpay.png')); ?>"
                            height="30">
                        <label class="aiz-switch aiz-switch-success mb-0 float-right">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure Razor correctly to enable this feature')); ?>. <a
                            href="<?php echo e(route('payment_method.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        <img class="float-left" src="<?php echo e(static_asset('assets/img/cards/paystack.png')); ?>"
                            height="30">
                        <label class="aiz-switch aiz-switch-success mb-0 float-right">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure PayStack correctly to enable this feature')); ?>. <a
                            href="<?php echo e(route('payment_method.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure VoguePay correctly to enable this feature')); ?>. <a
                            href="<?php echo e(route('payment_method.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure Payhere correctly to enable this feature')); ?>. <a
                            href="<?php echo e(route('payment_method.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure Ngenius correctly to enable this feature')); ?>. <a
                            href="<?php echo e(route('payment_method.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure iyzico correctly to enable this feature')); ?>. <a
                            href="<?php echo e(route('payment_method.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure bkash correctly to enable this feature')); ?>. <a
                            href="<?php echo e(route('payment_method.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure nagad correctly to enable this feature')); ?>. <a
                            href="<?php echo e(route('payment_method.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        <img class="float-left" src="<?php echo e(static_asset('assets/img/cards/aamarpay.png')); ?>"
                            height="30">
                        <label class="aiz-switch aiz-switch-success mb-0 float-right">
                            <input type="checkbox" onchange="updateSettings(this, 'aamarpay')"
                                <?php if(get_setting('aamarpay') == '1'): ?> checked <?php endif; ?>>
                            <span class="slider round"></span>
                        </label>
                    </div>
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure amarpay correctly to enable this feature')); ?>. <a
                            href="<?php echo e(route('payment_method.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        <img class="float-left" src="<?php echo e(static_asset('assets/img/cards/authorizenet.png')); ?>"
                            height="30">
                        <label class="aiz-switch aiz-switch-success mb-0 float-right">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure authorize net correctly to enable this feature')); ?>. <a
                            href="<?php echo e(route('payment_method.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure payku net correctly to enable this feature')); ?>. <a
                            href="<?php echo e(route('payment_method.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        <img class="float-left" src="<?php echo e(static_asset('assets/img/cards/mercadopago.png')); ?>"
                            height="30">
                        <label class="aiz-switch aiz-switch-success mb-0 float-right">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure Mercadopago correctly to enable this feature.')); ?> <a
                            href="<?php echo e(route('payment_method.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure Facebook Client correctly to enable this feature')); ?>. <a
                            href="<?php echo e(route('social_login.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure Google Client correctly to enable this feature')); ?>. <a
                            href="<?php echo e(route('social_login.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure Twitter Client correctly to enable this feature')); ?>. <a
                            href="<?php echo e(route('social_login.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0 h6 text-center"><?php echo e(translate('Apple login')); ?></h3>
                </div>
                <div class="card-body text-center">
                    <label class="aiz-switch aiz-switch-success mb-0">
                    ...
                    <div class="alert"
                        style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        <?php echo e(translate('You need to configure Apple Client correctly to enable this feature')); ?>. <a
                            href="<?php echo e(route('social_login.index')); ?>"><?php echo e(translate('Configure Now')); ?></a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/active-ecommerce/resources/views/backend/setup_configurations/activation.blade.php ENDPATH**/ ?>