            ...
            <div class="card install-card position-relative">
                ...
                <div class="card-body install-card-body h-100 w-100 z-3 position-relative">
                    ...
                    <div class="mb-4 pb-4 absolute-bottom-left right-0 d-flex justify-content-center">
                        <a href="<?php echo e(env('APP_URL')); ?>" class="btn btn-primary text-uppercase mr-3" style="border-radius: 1.5rem !important;">Go to Frontend Website</a>
                        <a href="<?php echo e(env('APP_URL')); ?>/admin" class="btn text-uppercase btn-success" style="border-radius: 1.5rem !important;">Login to Admin panel</a>
                    </div>
                </div>
...
<?php echo $__env->make('backend.layouts.blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/active-ecommerce/resources/views/installation/step6.blade.php ENDPATH**/ ?>